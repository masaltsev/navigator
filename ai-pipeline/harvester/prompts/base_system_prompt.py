...
Целевые классы расширены: жизненные ситуации (одиночество, передача опыта, цифровая изоляция, адаптация жилья, опекуны, ветераны); услуги — событийное/социальное/интеллектуальное/экологическое волонтерство, обучение ТСР, группы поддержки, когнитивная стимуляция; типы организаций — центры активного долголетия, Добро.Центры, пункты проката ТСР, центры дневного пребывания; специалисты — реабилитационная работа в соцсфере, равный консультант/компаньон, геронтопсихолог, цифровой куратор.
